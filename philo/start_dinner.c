...
void	create_threads(t_data *data)
{
	...
	if (!p)
		printf("Error memory allocation for p threads.\n");
	data->people = malloc(sizeof(t_philo) * data->max_philo);
	if (!data->people)
		printf("Error memory allocation for data->people.\n");
	i = 0;
	while (i < data->max_philo)
	{
...
/*Rotina inicializada pela thread criada*/
...
/*Join em threads, encerra mutexes, free em memória alocada*/
